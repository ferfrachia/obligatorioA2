...
for (var i =0;i<usuarios.vLength;i++){
		...
		if (Firmantes.vIsMember(usuarios.vArray[i])){
			...
			document.write('<tr> <td class="TablaIconoChico" > <img src="'+DirABS()+'icon_valid.gif?OpenImageResource"> </td> <td class="TextoFirmaOK">Firmado electronicamente por ' +usuario+'. </td></tr>');
		} else{
