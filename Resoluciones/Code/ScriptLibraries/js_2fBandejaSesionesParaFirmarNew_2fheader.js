...
function cargarBandejaSesParaFirmar(){
	actualizarAltos();
	...
	document.getElementById('BandejaSesParaFirmar').style.overflow = "hidden";
	document.getElementById('BandejaSesParaFirmar').style.width = "0";
	document.getElementById('BandejaSesParaFirmar').style.heigth = "0";
	
	var path = DirABS();
	autor = document.getElementsByName("Autores")[0].value;
	var strXml = DirABS()+"/SesionesParaFirmar?OpenView&count=5000&RestrictToCategory="+autor;
	var mygrid = new dhtmlXGridObject('BandejaSesParaFirmar');
	mygrid.attachEvent("onXLE", cargarCantidadDocs);
	mygrid.setImagePath("/codebase/imgs/");
	mygrid.setHeader("Nº Sesión,Fecha,Tipo",null,[estiloHeader,estiloHeader,estiloHeader]);
	...
	document.getElementById('BandejaSesParaFirmar').style.overflow = "hidden";
	document.getElementById('BandejaSesParaFirmar').style.width = "100%";
	document.getElementById('BandejaSesParaFirmar').style.heigth = "100%";
	if(navigator.appName == "Netscape")
		document.getElementById('CabezalBandejaSesParaFirmarWrap').style.width = calcularAncho() - 18 +"px";
}

window.onresize = resize;
function resize()
{
	document.getElementById('BandejaSesParaFirmar').style.height = "100%";
	if(grid != null){
		grid.setSizes();
	}
	document.getElementById('BandejaSesParaFirmar').style.width = "100%";
...
function actualizarAltos(){
	...
	if(ALTO_MAXIMIZADA<0)
		ALTO_MAXIMIZADA = 0;
	document.getElementById('CabezalBandejaSesParaFirmarWrap').style.height = ""+ALTO_MAXIMIZADA+"px";
}
