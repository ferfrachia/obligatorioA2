...
function cargarBandejasesiones(){
	...
	mygrid.setInitWidths("25,200,200,*");
...
function mostrarFiltro(i){
	...
	if(filtro == 0){
		grid.attachHeader(",#text_filter,#text_filter,#text_filter",[estiloAttachHeader,estiloAttachHeader,estiloAttachHeader,estiloAttachHeader]);
		grid.attachHeader(",#text_filter,#text_filter,#text_filter",[estiloAttachHeader,estiloAttachHeader,estiloAttachHeader,estiloAttachHeader]);
