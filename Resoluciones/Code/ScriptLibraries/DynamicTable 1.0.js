 ...
 */
DynamicTable.prototype.loadTable = function(pathSrv){
	try{
...
function generateRow(tableVarName,id,fieldsArray,cantCols,editEnabled,deleteEnabled,editable,pathSrv){
	try{
		...
		if(editable){
			...
			if(deleteEnabled)
				res += "<td><img width=\"20\" align=\"top\" height=\"20\" onClick=\""+tableVarName+".deleteRow('"+id+"')\" src=\""+pathSrv+"images/icons/remove.gif?OpenImageResource\"></td></tr>";
		}
		return res;
	}catch (e){
