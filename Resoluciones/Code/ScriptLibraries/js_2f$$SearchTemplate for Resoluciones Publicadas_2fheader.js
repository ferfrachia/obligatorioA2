...
function abrirDoc(univid){
	...
	window.open(pathname+'/Resolucion Publicada?OpenForm&id='+univid+'&urlorigen='+urlorigen,'Resolucion','menubar=no,status=yes,resizable=yes,scrollbars=yes,width=790,height=590');
}