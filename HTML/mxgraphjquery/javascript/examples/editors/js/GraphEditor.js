/*
 * $Id: GraphEditor.js,v 1.50 2010/04/29 09:33:53 gaudenz Exp $
...
function main()
{
    ...
    var node = mxUtils.load('/mxgraph/javascript/examples/editors/resources/default-style.xml').getDocumentElement();
	...
	insertVertexTemplate(library, graph, 'Pentagon', 'images/Pentagon.gif', 'ellipse;shape=Pentagon', 80, 60);
