...
* Parametros:
	 ...
	 * 	-validator		: funciÃƒÂ³n de validaciÃƒÂ³n del agregado de filas fila (returna un string conteniendo mensaje de errores)
	 ...
	 * 	-dynTableDiv	: id del div que contiene los campos domino y html donde estara la tabla dinÃƒÂ¡mica.
...
function DynamicTable(cantColumns,header,dominoFields,htmlFields,tableId,columnKey,validator,tableVarName,editEnabled,deleteEnabled,dynTableDiv,tableWidth,editable){
	try {
		...
		if(tableId == "")
			msgError += "Parámetro 'tableId' inválido: debe ingresar el identificador html de la tabla. \n";	
...
DynamicTable.prototype.loadTable = function(){
	try{
		...
		htmlDATA += "		<table id=\""+this.tableId+"\" class=\"DragContainer\">";
...
//Actualiza el tamaÃƒÂ±o de las imagenes de edicion y borrado
DynamicTable.prototype.updateImgSize = function (imgWidth,imgHeight){
	this.imgHeight = imgHeight;
	this.imgWidth  = imgWidth;
}

//Actualiza la ruta de las imagenes para las acciones de edicion y borrado de cada fila
DynamicTable.prototype.updateImgsPath = function (editImgPath, removeImgPath){
...
//Activa o desactiva la opcion de arrastrar y soltar cada fila de la tabla
DynamicTable.prototype.setDraggable = function (draggable){
	this.draggable = draggable;
}

//Especifica la clase css para los 2 botones de la tabla (agregar y modificar)
DynamicTable.prototype.updateButtonsClass = function (button1Class,button2Class){
