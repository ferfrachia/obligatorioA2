// $Id: mxStylesheetCodec.cs,v 1.7 2010-04-30 07:28:15 gaudenz Exp $
		    ...
		    if (obj is mxStylesheet)
		    {
                ...
                foreach (KeyValuePair<string, Dictionary<string, Object>> entry in stylesheet.Styles)
                {
                    ...
                    foreach (KeyValuePair<string, Object> entry2 in entry.Value)
                    {
                        ...
                        entryNode.SetAttribute("value", (string) entry2.Value);
                ...
                while (node != null)
                {
                        ...
                        node is XmlElement)
                    {
                        ...
                        if (name != null && name.Length > 0)
                        {
                            ...
                            Dictionary<string, Object> style = (extend != null) ?
