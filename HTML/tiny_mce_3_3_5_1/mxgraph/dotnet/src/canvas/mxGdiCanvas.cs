// $Id: mxGdiCanvas.cs,v 1.83 2011-01-05 11:20:51 gaudenz Exp $
    ...
    public class mxGdiCanvas : mxBasicCanvas
    {
                ...
                Dictionary<string, Object> style)
        {
            ...
            Brush brush = new LinearGradientBrush(area, Color.FromArgb((int)(255 * 0.9), 255, 255, 255),
                Color.FromArgb((int)(255 * 0.3), 255, 255, 255), LinearGradientMode.Vertical);

            GraphicsPath path = new GraphicsPath();
            path.AddLine(x, y - 1, x, (int)(y + h * size));
            // FIXME: Use quadratic curve here via x + w / 2, y + h * 0.7
            path.AddBezier(x, (int)(y + h * size),
                (int)(x + w * 0.3),
                (int)(y + h * 0.6),
                (int)(x + w * 0.7),
                (int)(y + h * 0.6),
