// $Id: mxGraph.cs,v 1.101 2010-12-02 10:31:26 gaudenz Exp $
                ...
                bool outgoing, bool includeLoops)
        {
            ...
            foreach (Object edge in edges)
            {
                ...
                if (includeLoops || ((source != target) &&
                    (incoming && target == cell && (parent == null || model
                        .GetParent(source) == parent))
                        || (outgoing && source == cell && (parent == null || model
