...
function cargarBandejaNotificaciones(){
	...
	var strXml = DirABS()+"/Notificaciones Internas?OpenView&count=5000";
	var mygrid = new dhtmlXGridObject('BandejaNotificaciones');
	mygrid.attachEvent("onXLE", cargarCantidadDocs);
	mygrid.setImagePath("/codebase/imgs/");
	mygrid.setHeader("Nº Comunicación,Nº Resolución,Fecha Comunicación,Destinatarios",null,[estiloHeader,estiloHeader,estiloHeader,estiloHeader]);
