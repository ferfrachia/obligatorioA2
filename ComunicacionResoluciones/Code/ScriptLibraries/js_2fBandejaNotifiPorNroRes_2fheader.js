...
function cargarBandejaNotificaciones(){
	...
	var strXml = DirABS()+"/Notificaciones Por Numero Resolucion?OpenView&count=5000";
	var mygrid = new dhtmlXGridObject('BandejaNotificaciones');
	mygrid.attachEvent("onXLE", cargarCantidadDocs);
	mygrid.setImagePath("/codebase/imgs/");
	mygrid.setHeader("Nº Resolución,Nº Comunicación,Fecha Comunicación,Tipo,Destinatarios",null,[estiloHeader,estiloHeader,estiloHeader,estiloHeader,estiloHeader]);
