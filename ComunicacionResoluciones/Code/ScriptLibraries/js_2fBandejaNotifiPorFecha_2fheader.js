...
function cargarBandejaNotificaciones(){
	...
	var strXml = DirABS()+"/Notificaciones Por Fecha?OpenView&count=5000";
	var mygrid = new dhtmlXGridObject('BandejaNotificaciones');
	mygrid.attachEvent("onXLE", cargarCantidadDocs);
	mygrid.setImagePath("/codebase/imgs/");
	mygrid.setHeader("Fecha Comunicación,Nº Comunicación,Nº Resolución,Tipo,Destinatarios",null,[estiloHeader,estiloHeader,estiloHeader,estiloHeader,estiloHeader]);
